...
async def get_calls_sub_kpis(
    ...
    return {
        ...
        "SLA":round(get_sla_percentage(query, start_date=start_date, end_date=end_date, domain=domain), 2),
        # "Prev SLA":round(get_sla_percentage(query, start_date=prev_start_date, end_date=prev_end_date), 2),
        "SLA_change":calculate_percentage_change(get_sla_percentage(query, start_date=start_date, end_date=end_date, domain=domain), get_sla_percentage(query, start_date=prev_start_date, end_date=prev_end_date, domain=domain)),
        "avg wait time": round(get_average_wait_time(query, start_date=start_date, end_date=end_date, domain=domain), 2),
        "avg wait time_change":calculate_percentage_change(get_average_wait_time(query, start_date=start_date, end_date=end_date, domain=domain), get_average_wait_time(query, start_date=prev_start_date, end_date=prev_end_date, domain=domain)),
        "max. wait time": round(get_max_wait_time(query, start_date=start_date, end_date=end_date, domain=domain), 2),
        "max. wait time_change":calculate_percentage_change(get_max_wait_time(query, start_date=start_date, end_date=end_date, domain=domain), get_max_wait_time(query, start_date=prev_start_date, end_date=prev_end_date, domain=domain)),
        "After call work time": round(get_inbound_after_call(query, start_date=start_date, end_date=end_date, domain=domain), 2),
        "After call work time_change":calculate_percentage_change(get_inbound_after_call(query, start_date=start_date, end_date=end_date, domain=domain), get_inbound_after_call(query, start_date=prev_start_date, end_date=prev_end_date, domain=domain)),
