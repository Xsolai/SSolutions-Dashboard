...
const AnalyticsDashboard = ({ dateRange, selectedCompany }) => {
  ...
  }, [dateRange, selectedCompany, currentStatusFilter]); // Add currentStatusFilter here
  ...
  const TabButton = ({ selected, children, onClick }) => (
    <button
      onClick={onClick}
      className={`px-6 py-3 text-[17px] leading-[27px] font-nexa-black transition-all duration-200 border-b-2 ${selected
